  ...
  const treeData = [
    {
      ...
      key: '0-0',
      children: [
        { title: '计量项目 0-0-0', key: '0-0-0', isLeaf: true },
        { title: '计量项目 0-0-1', key: '0-0-1', isLeaf: true },
      ],
    },
    {
      title: '计量项目分类 1',
      key: '0-1',
      children: [
        { title: '计量项目 0-1-0', key: '0-1-0', isLeaf: true },
        { title: '计量项目 0-1-1', key: '0-1-1', isLeaf: true },
      ],
    },
  ];
